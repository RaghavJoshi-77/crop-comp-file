...
export default function AiMagic() {
  ...
  const [isPromptSet, setIsPromptSet] = useState(false); // State to track if prompt is set
  ...
  const handleSetPrompt = () => {
    if (prompt.trim() === "") {
      alert("Please enter a valid prompt before proceeding.");
      return;
    }
    setIsPromptSet(true);
  };
  ...
  return (
    <div className="container mx-auto p-4 max-w-4xl">
      <h1 className="text-3xl font-bold mb-6 text-center">Ai-Magic</h1>
      <div className="card">
            ...
            <div className="mt-6">
              <div className="flex justify-between items-center mb-4">
                ...
                <button
                  ...
                  disabled={isTransforming || isDownloading} // Disable if transforming or downloading
                >
                  {isDownloading ? "Loading..." : "Download Image"}{" "}
                  {/* Show loading text */}
                </button>
              </div>
              ...
              <div className="relative border rounded-lg overflow-hidden">
                ...
                <CldImage
                  ...
                  src={uploadedImage}
                  ref={imageRef}
                  replaceBackground={isPromptSet ? prompt : undefined} // Ensure prompt is set
